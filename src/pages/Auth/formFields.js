export const formFieldsConfig = {
    lastName: { label: 'Фамилия', type: 'text', required: true, placeholder: 'Иванов', modes: ['register'] },
    firstName: { label: 'Имя', type: 'text', required: true, placeholder: 'Иван', modes: ['register'] },
    middleName: { label: 'Отчество', type: 'text', required: true, placeholder: 'Иванович', modes: ['register'] },
